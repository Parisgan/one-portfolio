    ...
    <div className="container">
      ...
      {showPopup && (
        <div className="popup-container">
          ...
          <div className="popup fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border border-gray-300 shadow-md rounded-lg p-4 bg-white opacity-90">
